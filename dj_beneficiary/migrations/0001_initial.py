    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('district', models.ForeignKey(default=1, help_text='District in which the facility is located', max_length=250, on_delete=django.db.models.deletion.CASCADE, to='dj_beneficiary.district')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=255, verbose_name='District')),
                ('created', models.DateTimeField(auto_now_add=True)),
                ('district', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dj_beneficiary.district')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_females', models.IntegerField(blank=True, null=True)),
                ('total_males', models.IntegerField(blank=True, null=True)),
                ('total_hhs', models.IntegerField(blank=True, null=True)),
                ('female_hhs', models.IntegerField(blank=True, null=True)),
                ('sixteen_to_thirty', models.IntegerField(blank=True, null=True)),
                ('thirty_to_fourty_five', models.IntegerField(blank=True, null=True)),
                ('above_fourty_five', models.IntegerField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('agent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='dj_beneficiary.agent')),
                ('registered_facility', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='registerd_facility', to='dj_beneficiary.facility')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='facility',
            name='facility_type',
            field=models.ForeignKey(default=1, help_text="Facility Type, i.e 'Hospital, Clinic etc", max_length=250, on_delete=django.db.models.deletion.CASCADE, to='dj_beneficiary.facilitytype'),
        ),
        migrations.AddField(
            model_name='facility',
            name='implementing_partner',
            field=models.ForeignKey(blank=True, help_text='Related Implementing Partner.', max_length=250, null=True, on_delete=django.db.models.deletion.SET_NULL, to='dj_beneficiary.implementingpartner'),
        ),
        migrations.AddField(
            model_name='district',
            name='province',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dj_beneficiary.province'),
        ),
    ]
